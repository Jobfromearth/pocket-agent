...
python -m pocket eval     # 84 deterministic checks, offline and free, in under a second
...
The core imports **stdlib only** and `pocket/*.py` totals **5,353 lines**; `anthropic` /
