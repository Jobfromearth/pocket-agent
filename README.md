...
python -m pocket eval     # 116 deterministic checks, offline and free, in under a second
...
The core imports **stdlib only** and `pocket/*.py` totals **6,759 lines**; `anthropic` /
