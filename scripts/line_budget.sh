...
printf "  %-10s %5s  %s\n" memory    "$(count pocket/memory.py pocket/db.py pocket/skills.py)"                       "memory db skills"
printf "  %-10s %5s  %s\n" context   "$(count pocket/context.py)"                                                    "context"
printf "  %-10s %5s  %s\n" reach     "$(count pocket/mcp.py pocket/web.py pocket/subagent.py)"                       "mcp web subagent"
